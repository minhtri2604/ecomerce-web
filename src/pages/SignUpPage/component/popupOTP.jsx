        ...
        <div className="flex flex-col items-center mx-[86px]">
          <>
            ...
            {/* <BtnContinue
                ...
                } mb-[33px] mt-[25px] flex-center gap-x-[25px] bg-[--border-color] px-[20px] py-[10px] rounded-[28px]`}
